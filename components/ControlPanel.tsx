...
// A more accurate representation of the logo from the image
const Logo = () => (
    <div className="w-24 h-24 mx-auto bg-black rounded-full flex items-center justify-center mb-2 border-2 border-gcs-orange">
        <svg xmlns="http://www.w3.org/2000/svg" className="w-20 h-20 text-gcs-orange" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1">
            {/* Drone body */}
            ...
            {/* Mosquito body */}
            <path d="M12,16 C11,17 10,18 10,19" />
            <path d="M12,16 C13,17 14,18 14,19" />
            <line x1="12" y1="16" x2="12" y2="21" strokeWidth="0.5" />
            {/* Mosquito legs */}
            <path d="M11,19.5 L9,21" />
            <path d="M13,19.5 L15,21" />
             {/* Outer Circle */}
